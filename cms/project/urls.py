...
urlpatterns = [
    ...
    path("home_faculty", views.home_faculty, name="home-faculty"),
    path("home_student", views.home_student, name="home-student"),
    ...
    path('show_application/<application_id>', views.show_application, name='show-application'),
    ...
    path('faculty_tab', views.faculty_tab, name='faculty-tab'),
